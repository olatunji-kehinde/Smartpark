    ...
    <div class="signup__container">
        <div class="container__child signup__thumbnail">
            <div class="thumbnail__logo">
                <h1 class="logo__text">SMART PARKING RESERVATION</h1>
            </div>
            <div class="thumbnail__content">
                <h1 class="heading--primary">Welcome to Smart Park.</h1>
        ...
        <div class="container__child signup__form">
            <form action="http://localhost/sswt/register_html.php" method="post">
                ...
                <div class="foot">
                    <input class="btn btn--form" type="submit" id="reg" value="SIGN UP" name="reg_user" />
