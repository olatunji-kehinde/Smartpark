    ...
    <body>
        ...
        <div class="select">
            <form action="dbase_html.php" method="POST">
                <input type="date" name="start" min="2021-04-11" max="2022-12-31"> &nbsp;&nbsp; to &nbsp;&nbsp; 
                <input type="date" name="end" min="2021-04-12" max="2022-12-31"> <br><br> <input type="submit" name="getrec" id="records" value="Search">
            </form>
        </div>
        <div class="container">
